...
def generate_itinerary():
    ...
    itinerary = response["text"]  # Extract text from response
    
    chat_enabled = True  # Enable chat
    return jsonify({"itinerary": itinerary.strip(), "chat_enabled": chat_enabled})
...
def chat():
    ...
    response = llm(user_message)  # Get response from LLM
